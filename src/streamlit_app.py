...
The ultimate goal of **SpectraStream ** is to empower users to generate harmonized spectra effortlessly. By leveraging CHARISMA developed [[ https://github.com/h2020charisma/ramanchada2 | ramanchada2  ]] library in the background, **SpectraStream ** ensures that even users with minimal technical knowledge can achieve accurate and consistent results.

### Key Features

#### Ideal User Profile

If you have reference materials, your samples, and a Raman system, you're all set to benefit from SpectraStream  and  [[ https://www.h2020charisma.eu/ | CHARISMA  ]] calibration protocols. Here's what you need to do:
